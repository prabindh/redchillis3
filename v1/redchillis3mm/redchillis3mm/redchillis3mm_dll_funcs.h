/**
* This file contains description of the REDCHILLIS3 Sample DLL API.
* These functions are available in DLL form, and can be imported into
* other DLLs, or into other executables or runtimes. This is sample code.
*/
...
;
#endif //_REDCHILLIS3MM_DLL_FUNCS_H